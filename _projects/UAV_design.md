...
The team consisted of 6 members, and this competition evaluated aerial robot's capability in autonomous flight, object detection, precision, and stability. I was responsible for the mechanical design of the drone, and I also reconstructed a trapezoidal cube obstacle (Salt mountain) for algorithm validation. The demo for the line following function and Salt mountain is shown below.
...
Here is the video of me teleoperating the UAV during trials to collect flight data for autonomous line tracking.
